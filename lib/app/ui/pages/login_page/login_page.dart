            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Center(child: Image.asset('assets/login/ic_fasting.png',scale: .4.h)),
                  Text(
                    'LOG IN',
                      ...
                      child: TextFormField(
                        decoration: InputDecoration(
                          prefixIcon: Icon(Icons.email),
                            hintText: 'E-mail (exp: example@email.com)',
                            hintStyle: TextStyle(
                                color: Colors.grey,
                                fontSize: 2.1.h,
                    ...
                    child: InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              child: Center(child: Text('LOG IN',style: TextStyle(color: Colors.grey.shade600,
                              fontSize: 20,
